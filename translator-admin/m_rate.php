...
?>
          ...
          <div id="content-header" class="clearfix">
            <div class="pull-left">
              <ol class="breadcrumb">
                ...
                <li class="active"><span>Rate</span></li>
              </ol>
              <h1>Rate</h1>
            </div>
          </div>
                       ...
                       <?php										
						...
						while( $result = mysqli_fetch_assoc( $sql ) ){							 							
							...
							if($result['status']=='A'){	
								...
								echo" <td><a href='admin_code/update_status.php?rate_id={$result['id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";							  				
							} 							
							else						
							{
								
								echo" <td><a href='admin_code/update_status.php?rate_id={$result['id']}'><button style='background-color:green; color:white'>Active</button></a></td>";									
							}						
							echo "</tr>\n";			
						}					
						?>
  ...
  .modal-body input[type="text"]{padding: 10px 15px; width: 100%;}
  .modal-body button{margin: 25px 0px;}
  .body_space{margin:15px 0px; text-align: left;}
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
			<form action="admin_code/m_rate.php" method="POST">				
				<input type="text" name="rate"  placeholder="Rates">	
				<div class="row body_space">
				<div class="col-md-2"> Type: </div>
				<div class="col-md-3">
					<label class="radio-inline">
					  <input type="radio" name="type" id="inlineRadio2" value="per_page"> Per Page
					</label>
				</div>
				<div class="col-md-3">
					<label class="radio-inline">
					  <input type="radio" name="type" id="inlineRadio3" value="per_hour"> Per Hour
					</label>
				</div>
				</div>
