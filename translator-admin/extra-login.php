...
<div class="wrapper-page">
  <div class="panel panel-color panel-primary panel-pages">
    <div class="panel-heading bg-img">
      ...
      <h3 class="text-center m-t-10 text-white">Sign in to your account</h3></div>
    <div class="panel-body">
      <form class="form-horizontal m-t-20" action="admin_code/admin_login.php" method='POST'>
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-lg-6 col-xs-12 p-l-20">
              <div class="checkbox checkbox-primary">
                <input id="checkbox-signup" type="checkbox">
                <label for="checkbox-signup">Remember me</label>
              </div>
            </div>
            <div class="col-lg-6 col-xs-12 text-right p-r-20" style="margin-top: 7px;">
        ...
        <div class="form-group text-center m-t-40">
          <div class="col-xs-12">
            <button class="btn btn-block btn-lg btn-primary waves-effect waves-light" type="submit" name='submit'>Sign In</button>
          </div>
        </div>
      </form>
    </div>
