          ...
          <div id="content-header" class="clearfix">
            <div class="pull-left">
              <ol class="breadcrumb">
                ...
                <li class="active"><span>Upcoming Schedule</span></li>
              </ol>
                  ...
                  <div class="row">
					...
					<div class="table_out">
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                       <?php
						$select="select * from `pro_u_awarded` RIGHT OUTER JOIN `project` ON `pro_u_awarded`.`pro_id`=`project`.`id` where `pro_u_awarded`.`running_status`='W'";
						...
						while($res=mysqli_fetch_array($que)){
                            ...
                            <td>{$res['pro_type']}</td>";
							if($res['for_project']=='PU'){
								echo" <td>Public</td>";
							}else{
								echo" <td>Private</td>";
							}
                           echo" <td><a href='clients-details.php?cus_id={$res2['login_id']}'>{$res2['f_name']}  {$res2['l_name']}</a></td>
                            <td><a href='translator-details.php?id={$res1['login_id']}'>{$res1['f_name']}  {$res1['l_name']}</a></td>
                            <td>{$res['datetime']}</td>";
							if($res['running_status']=='W'){
								echo" <td>Working</td>";
							}
							else{
								echo"<td></td>";
							...
							/**if($res['status']=='A'){								  						
								echo" <td><a href='admin_code/update_status.php?up_id={$res['pro_id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";				  						
							} 							
							else							
							{								
								echo" <td><a href='admin_code/update_status.php?up_id={$res['pro_id']}'><button style='background-color:green; color:white'>Active</button></a></td>";
							} **/ 
                        echo"</tr>";
