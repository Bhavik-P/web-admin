                  ...
                  <div class="row">
					...
					<div class="table_out">
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
								<?php						
								$select="select *,`u_details`.`login_id` AS `c_id` from `u_details` LEFT OUTER JOIN `u_login` ON `u_details`.`login_id`=`u_login`.`id` where `u_login`.`type`='CU'";						
								...
								while($res=mysqli_fetch_array($que)){							
									...
									echo"<tr>						
									<td>$count</td>					
									<td><a href='clients-details.php?cus_id={$res['c_id']}'>{$res['f_name']}  {$res['l_name']}</a></td>                       
									<td>{$res['address']}</td>                       
									<td>{$res['email_id']}</td>";						
									...
									if($res['admin_status']=='A'){								  						
										echo" <td><a href='admin_code/update_status.php?cus_id={$res['c_id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";				  						
									} 							
									else							
									{								
										echo" <td><a href='admin_code/update_status.php?cus_id={$res['c_id']}'><button style='background-color:green; color:white'>Active</button></a></td>";
									}  
									echo"<td><a href='admin_code/delete.php?c_id=".$res['c_id']."'><i class='fa fa-trash'></i></a></td>";										
									echo"</tr>";					
								}												
						?>
                        </tbody>
