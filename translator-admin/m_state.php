                  ...
                  <div class="row">
					...
					<div class="table_out">
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
                        <?php											
						$query="Select * from `country` RIGHT OUTER JOIN `state` ON country.id=state.country_id";	
						...
						while( $result = mysqli_fetch_assoc( $sql ) ){							
							...
							if($result['status']==1){							
								echo" <td><a href='admin_code/update_status.php?state_id={$result['id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";					
							}						
							else						
							{						
								echo" <td><a href='admin_code/update_status.php?state_id={$result['id']}'><button style='background-color:green; color:white'>Active</button></a></td>";	
							}											
							echo "</tr>\n";						
						}						
						?>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<form action="admin_code/m_state.php" method="POST">		
			<select name="m_country" aria-controls="datatable" class="form-control input-sm">				
			<option value="">Select Country</option>				
			<?php 																
			$query="select * from `country` where `status`='1' order by `id`";				
			$sql=mysqli_query($con,$query);					
