          ...
          <div id="content-header" class="clearfix">
            <div class="pull-left">
              <ol class="breadcrumb">
                ...
                <li class="active"><span>All Reviews & Rating</span></li>
              </ol>
              <h1>All Reviews & Rating</h1>
            </div>
          </div>
                  ...
                  <div class="row">
					...
					<div class="table_out">
                      <table id="datatable" class="table table-striped table-bordered">
                        ...
                        <tbody>
						<?php
						$select="select * from `pro_review_rating`";
						...
						while($res=mysqli_fetch_array($que)){
							...
							$que3=mysqli_query($con,$select_p);
							...
							<td>{$pro_id}</td>
							<td><a href='project-detail.php?pro_id={$pro_id}'>{$res3['project_name']}</a></td>";
							$rating=$res['rating'];
							$review=$res['review'];
							...
							if ( $intpart <= 5 ) {
							for ( $i=0; $i<$intpart; $i++ )
								echo"<img id='".$pro_id."' onclick='review(this.id)'  src='assets/images/icon/star1.png' height='20px' width='20px'>";
							}
							if ( $fraction >= 0.8 ) {
								echo "<img id='".$pro_id."' onclick='review(this.id)'  src='assets/images/icon/star1.png' height='20px' width='20px'>";
							}
							if ( $fraction >= 0.5 && $fraction<=0.7 ) {
								echo "<img id='".$pro_id."' onclick='review(this.id)' src='assets/images/icon/half_star.png' height='20px' width='20px'>";
							}
							if ( $unrated > 0 ) {
								for ( $j=0; $j<$unrated; $j++ )
								echo "<img id='".$pro_id."' onclick='review(this.id)' src='assets/images/icon/blank_star.png' height='20px' width='20px'>";
							}
							echo "($rating)";
							echo"</td>";
							if($res['status']=='A'){								  						
								echo" <td><a href='admin_code/update_status.php?rat_id={$pro_id}'><button style='background-color:red; color:white'>Deactive</button></a></td>";				  						
							} 							
							else							
							{								
								echo" <td><a href='admin_code/update_status.php?rat_id={$pro_id}'><button style='background-color:green; color:white'>Active</button></a></td>";
							}  
							echo" </tr>";
