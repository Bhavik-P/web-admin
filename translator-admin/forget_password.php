...
<div class="wrapper-page">
  <div class="panel panel-color panel-primary panel-pages">
    <div class="panel-heading bg-img">
      ...
      <h3 class="text-center m-t-10 text-white">Foget Password</h3></div>
    <div class="panel-body">
      <form class="form-horizontal m-t-20" action="admin_code/forget_pass.php" method="POST">
        ...
        <div class="form-group text-center m-t-40">
          <div class="col-xs-12">
            <button class="btn btn-block btn-lg btn-primary waves-effect waves-light" type="submit" name="forget_pass">Submit</button>
          </div>
        </div>
      </form>
    </div>
