					...
					<div class="table_out">
                      <table id="datatable" class="table table-striped table-bordered">
						...
						while( $result = mysqli_fetch_assoc( $sql ) ){							 							
							...
							if($result['status']=='A'){								  		
								echo" <td><a href='admin_code/update_status.php?lang_id={$result['id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";				
							} 						
							else		
							{				
								echo" <td><a href='admin_code/update_status.php?lang_id={$result['id']}'><button style='background-color:green; color:white'>Active</button></a></td>"; 		
							}							
							echo "</tr>\n";				
						}						
						?>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">		<form action="admin_code/m_language.php" method="POST">					<input type="text" name="language" value="" placeholder="language Name">			<button type="submit" id="submit" name="submit" class="btn btn-default"  > Submit </button>				</form>
        </div>
      </div>
