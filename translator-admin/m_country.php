                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      ...
                      <table id="datatable" class="table table-striped table-bordered">
						...
						while( $result = mysqli_fetch_assoc( $sql ) ){							 							
							...
							echo" <td><a href='admin_code/update_status.php?id={$result['id']}'><button style='background-color:red; color:white'>Deactive</button></a></td>";							  				
							} 							
							else						
							{
								
							echo" <td><a href='admin_code/update_status.php?id={$result['id']}'><button style='background-color:green; color:white'>Active</button></a></td>";									
							}						
							echo "</tr>\n";			
						}					
						?>
  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<form action="admin_code/m_country.php" method="POST">				
			<input type="text" name="country_name" value="" placeholder="Country Name">		
